      ...
      <div class="row justify-content-center">
        <div class="col-md-6">
          <div class="text-center">
            <strong style="color: #5673ff; font-size: 24px">常见问题FAQ</strong>
              ...
              <div class="col-lg-4">
                <div class="card faq-box border-primary">
                  <div class="card-body" style="height:16em">
                    ...
                    >点击导入.xlsx/.xls按钮，自动覆盖内容，不会影响下一次查询，也可以点击清除按钮或者刷新按钮，再重新导入</p>
                  </div>
                </div>
              </div>
  ...
  data() {
    return {
      banner: {
        // title: 'CHARTS',
        subTitle:
          " 如果你遇到了上述没有提到的问题，并且暂无法解决的话，请将遇到的问题发送到邮箱lafhhh@outlook.com，我们将及时为你解决.",
      },
    };
  },
};

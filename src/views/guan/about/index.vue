  ...
  <d2-container style="opacity: 0.4">
    <template slot="header">微逻辑配送</template>
           <li><h3 style="color:blue">团队名称</h3></li>
            ...
            <li> <h3 style="color:blue">LOGO简介</h3></li>
            <div>
            </div>
            <div>
            </div>
            <li><h3 style="color:blue">系统背景</h3></li>
            <p>
            ...
            <li><h3 style="color:blue">联系我们</h3></li>
            <p>电子邮件：lafhhh@outlook.com</p>
            <p>
                温馨提示：为了更好更快的帮您解决问题，请在邮件中留下联系方式、详细问题描述、相关截图等信息。
            </p>

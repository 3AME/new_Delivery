      ...
      <section id="cd-timeline" class="cd-container">
        ...
        <div class="row">
          <el-card shadow="hover" :body-style="{ padding: '3em' }">
            ...
            >随着信息技术的发展，现代<b>物流</b>作为“第三个利润源泉”是一种先进的组织方式和管理技术，已被世界各国广泛采用，并形成产业化，在国民经济中发挥越来越重要的作用，这一管理技术，正受到日益广泛的重视，并面临巨大的发展机遇，在现代物流中，配送是一个重要的与消费者直接相连的环节，一方面可以体现企业的核心竞争力，另一方面通过线路优化，可以<b>提高企业的运作效率</b>，<b>降低配送成本</b>，实现<b>物流科学化</b>。目前市场上仓储类管理系统已经比较完善，但对于不同需求的<b>路线规划</b>还存在一定的短板，基于当前站好“最后一岗”的要求，引用路线优化算法，开发出具有实用性，先进性，高可靠性的<b>路线规划系统</b>。</p>
          </el-card>
        </div>
        <div style="height:5em"></div>
        <el-divider></el-divider>
        ...
        <div class="row">
          ...
          <el-card style="margin-left:1em" shadow="hover">
            <img src="../../../assets/images/small/1_bak.png" height="200" style="float:right" />
          </el-card>
        </div>
        <div style="height:5em"></div>
        <el-divider></el-divider>
        ...
        <div class="row">
          <el-card shadow="hover">
            ...
            <p style="text-indent: 2em">
              团队取名
              <b>“微逻辑”</b>，与产品的定位与愿景息息相关。
              产品致力于物流配送方案的优化，在提供技术支持的同时希望全方位服务用户。
            </p>
            <p style="text-indent:2em">
              考虑到使用的算法约束十分复杂，隐藏背后的算法逻辑，同时给用户提供
